...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const views = {
        dashboard: { element: document.querySelector('.bmh-products-dashboard-view'), display: 'block' },
        card: { element: document.querySelector('.bmh-products-card-view'), display: 'flex' },
        list: { element: document.querySelector('.bmh-products-list-view'), display: 'flex' },
        calendar: { element: document.querySelector('.bmh-products-calendar-view'), display: 'block' },
        map: { element: document.querySelector('.bmh-products-map-view'), display: 'block' }
    };
