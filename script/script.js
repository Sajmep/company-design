...
// NEW SEPARATE NOTIFICATION DROPDOWN - completely independent
// Wait for DOM to be fully loaded
document.addEventListener('DOMContentLoaded', function() {
  const notificationDropdown = document.querySelector(".dropdown-notifications");

  if (notificationDropdown) {
    const notificationBtn = notificationDropdown.querySelector(".dropdown-notifications-btn");
    ...
    if (notificationBtn) {
      ...
      notificationBtn.addEventListener("click", function(e) {
        ...
        document.querySelectorAll('.dropdown-advanced, .dropdown-bell').forEach(dropdown => {
          dropdown.classList.remove('show');
        });
        
        // Toggle this dropdown
        notificationDropdown.classList.toggle("active");
        console.log('Dropdown active:', notificationDropdown.classList.contains('active'));
      });
